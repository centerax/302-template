...
\definecolor{ort}{rgb}{0, 0.313, 0.313}
\definecolor{ortrojo}{rgb}{0.4, 0.0627, 0.125}
...
% Para captions de texto sans-serif.
\newenvironment{mifuentephv}{\fontfamily{phv}\selectfont}{\par}
\DeclareTextFontCommand{\textmyfont}{\mifuentephv}
